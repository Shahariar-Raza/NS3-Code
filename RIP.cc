 ...
 int main (int argc, char **argv)
 {
   ...
   csma.EnableAsciiAll (ascii.CreateFileStream ("rip-routing.tr"));
   csma.EnablePcapAll ("rip-routing", true);
   ...
   anim.SetConstantPosition(src, 10.0, 50.0);
   anim.SetConstantPosition(dst, 90.0, 50.0);
   anim.SetConstantPosition(a, 30.0, 50.0);
   anim.SetConstantPosition(b, 50.0, 20.0);
   anim.SetConstantPosition(c, 50.0, 70.0);
   anim.SetConstantPosition(d, 70.0, 50.0);
